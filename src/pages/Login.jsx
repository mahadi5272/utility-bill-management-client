...
import { Slide, Zoom, Fade } from "react-awesome-reveal"; // ✨ animation imports
        ...
        <Slide direction="right">
          <div className="text-center lg:text-left">
            ...
            <p className="py-6 text-gray-700">
              Welcome back! Please login to access your account and manage your
              bills.
            </p>
          </div>
        </Slide>
          ...
          <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
            <div className="card-body">
              <Fade cascade damping={0.1}>
                <form onSubmit={handleSignIn} className="fieldset space-y-3">
                  <div>
